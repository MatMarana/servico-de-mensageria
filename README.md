...
> Serviço de troca de mensagens instantâneas entre clientes e servidores.

## Objetivo
O objetivo deste projeto é desenvolver uma versão simplificada dos servidores Bulletin Board System (BBS) para troca de mensagens e recebimento de notícias
...
## Contador Lógico e Heartbeat

### Alterações Necessárias
- **Adicionar o contador lógico:** Para isso vamos adicionar um contador tanto no cliente quanto no servidor que será enviado junto com as mensagens. O contador deve ser atualizado com o valor maxímo resultante da comparação entre o contador recebido e o exitente. *Exemplo:* Cliente envia contador = 1 e o contador do servidor está em 0. Quando o servidor receber o contador ele deixa o seu igual a 1 (valor máximo entre contador do cliente e do servidor), incrementaseu próprio contador e envia 2 para o cliente.

- **Adicionar rank dos servidores: **

## Eleição
Precisa da parte do rank funcionando
